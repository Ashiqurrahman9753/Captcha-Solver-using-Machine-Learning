...
def process_and_save_image(captcha_path):
    ...
    output_path = os.path.join(cwd,"preprocessedimg", encode_special_characters(captcha_label) + ".png")
...
if not os.path.exists(os.path.join(cwd,"preprocessedimg")):
    os.mkdir(os.path.join(cwd,"preprocessedimg"))

# loop over all the CAPTCHA images
captchas_path = os.path.join(cwd, "captchas", "*.png") # path to all CAPTCHAs
